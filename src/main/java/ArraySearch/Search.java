...
public class Search {
    ...
    /**
     * ArraySearch.Search a given number is present in an integer array by searching linearly
    ...
    /**
     * ArraySearch.Search a given number is present in an integer array by searching recursively in the array by checking
     * the last element
     * @param arr is the array of integers
     * @param number is the integer to be searched
     * @return {@code true} if the number is found, {@code false} if the number is not found
